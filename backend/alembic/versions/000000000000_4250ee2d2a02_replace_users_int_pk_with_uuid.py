"""replace users int pk with uuid
Revision ID: 4250ee2d2a02
Revises: 5a012bbe9928
Create Date: 2024-07-05 15:21:54.426720
"""
...
revision = "4250ee2d2a02"
down_revision = "5a012bbe9928"
branch_labels = None
depends_on = None
...
RELATIONSHIPS = [
    ...
    Relationship(
        ...
        ondelete="CASCADE",
        other_pk_col="role_id",
    ),
    Relationship(
        table_name="users_predefined_roles",
        ondelete="CASCADE",
        other_pk_col="predefined_role_id",
    ),
    Relationship(
        table_name="widgets",
        ondelete="CASCADE",
    ...
    Relationship(
        ...
        ondelete="CASCADE",
        other_pk_col="space_id",
        create_temporary_uuid_col=False,
    ),
    Relationship(
        table_name="websites",
        ondelete="CASCADE",
        create_temporary_uuid_col=False,
        fk_name="crawls_user_id_fkey",
    ),
    Relationship(
        table_name="groups",
        ondelete="CASCADE",
