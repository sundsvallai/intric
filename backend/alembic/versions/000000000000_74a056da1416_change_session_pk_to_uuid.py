"""change session pk to uuid
Revision ID: 74a056da1416
Revises: 77712c0b2743
Create Date: 2024-06-06 14:03:28.872491
"""
...
revision = '74a056da1416'
down_revision = '77712c0b2743'
branch_labels = None
depends_on = None
...
RELATIONSHIPS = [
    Relationship(
        ...
        fk_name="questions_session_id_fkey",
        ondelete="CASCADE",
    )
]
