"""replace info-blobs int pk with uuid
Revision ID: a6b31554ab18
Revises: 0b355bff351a
Create Date: 2024-07-01 10:10:05.948753
"""
...
RELATIONSHIPS = [
    ...
    Relationship(
        ...
        ondelete="CASCADE",
        fk_name="info_blob_references_reference_fkey",
    ),
]


def upgrade() -> None:
    op.drop_column("info_blob_references", "id")
    op.drop_column("info_blob_chunks", "info_blob_old_id")
