"""replace services int pk with uuid
Revision ID: ca3818d474d6
Revises: 15653e0a4395
Create Date: 2024-07-08 15:57:17.375677
"""
...
revision = 'ca3818d474d6'
down_revision = '15653e0a4395'
branch_labels = None
depends_on = None
...
RELATIONSHIPS = [
    Relationship(
        table_name="sessions",
        ondelete="CASCADE",
        fk_name="sessions_service_fkey",
    ),
    Relationship(
        table_name="steps",
        ondelete="SET NULL",
        col_name="assistant_id",
        fk_name="steps_services_fkey",
    ),
    Relationship(
        table_name="questions",
        ondelete="CASCADE",
        fk_name="questions_services_fkey",
    ),
    Relationship(
        table_name="services_groups",
        ondelete="CASCADE",
        other_pk_col="group_id",
    ),
    Relationship(
        table_name="usergroups_services",
        ondelete="CASCADE",
