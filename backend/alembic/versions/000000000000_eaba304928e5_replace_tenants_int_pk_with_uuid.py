"""replace tenants int pk with uuid
Revision ID: eaba304928e5
Revises: 13a322c49dd7
Create Date: 2024-07-02 14:32:25.112382
"""
...
revision = "eaba304928e5"
down_revision = "13a322c49dd7"
branch_labels = None
depends_on = None
...
RELATIONSHIPS = [
    ...
    Relationship(
        table_name="groups",
        ondelete="CASCADE",
        fk_name="group_tenant_fk",
    ),
    Relationship(
        table_name="roles",
        ondelete="CASCADE",
        fk_name="roles_tenant_fk",
    ),
    Relationship(
        table_name="tenants_modules",
        ondelete="CASCADE",
        other_pk_col="module_id",
    ),
    Relationship(
        table_name="users",
        ondelete="CASCADE",
        fk_name="users_tenants_fk",
    ),
    Relationship(
        table_name="websites",
        ondelete="CASCADE",
