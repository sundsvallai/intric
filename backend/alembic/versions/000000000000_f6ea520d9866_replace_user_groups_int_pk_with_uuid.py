"""replace user-groups int pk with uuid
Revision ID: f6ea520d9866
Revises: b68dffb9168e
Create Date: 2024-07-08 17:01:43.496410
"""
...
revision = 'f6ea520d9866'
down_revision = 'b68dffb9168e'
branch_labels = None
depends_on = None
...
RELATIONSHIPS = [
    ...
    Relationship(
        ...
        ondelete="CASCADE",
        other_pk_col="service_id",
    ),
    Relationship(
        table_name="usergroups_assistants",
        ondelete="CASCADE",
        other_pk_col="assistant_id",
    ),
    Relationship(
